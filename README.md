...
У сервиса будет своя база зарегистрированных пользователей (а может лучше вообще пользователей вообще выделить в отдельный сервис и написать к нему CRUD, а auth - будет только выдавать и проверять токены?)
